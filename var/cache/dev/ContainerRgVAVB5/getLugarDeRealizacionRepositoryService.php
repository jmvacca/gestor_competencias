 ...
 */
class getLugarDeRealizacionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LugarDeRealizacionRepository' shared autowired service.
     *
     * @return \App\Repository\LugarDeRealizacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LugarDeRealizacionRepository.php';

        return $container->privates['App\\Repository\\LugarDeRealizacionRepository'] = new \App\Repository\LugarDeRealizacionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
