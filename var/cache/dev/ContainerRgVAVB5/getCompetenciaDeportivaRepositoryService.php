 ...
 */
class getCompetenciaDeportivaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompetenciaDeportivaRepository' shared autowired service.
     *
     * @return \App\Repository\CompetenciaDeportivaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompetenciaDeportivaRepository.php';

        return $container->privates['App\\Repository\\CompetenciaDeportivaRepository'] = new \App\Repository\CompetenciaDeportivaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
