 ...
 */
class getModalidadRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ModalidadRepository' shared autowired service.
     *
     * @return \App\Repository\ModalidadRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModalidadRepository.php';

        return $container->privates['App\\Repository\\ModalidadRepository'] = new \App\Repository\ModalidadRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
