 ...
 */
class getDisponibilidadRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DisponibilidadRepository' shared autowired service.
     *
     * @return \App\Repository\DisponibilidadRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DisponibilidadRepository.php';

        return $container->privates['App\\Repository\\DisponibilidadRepository'] = new \App\Repository\DisponibilidadRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
