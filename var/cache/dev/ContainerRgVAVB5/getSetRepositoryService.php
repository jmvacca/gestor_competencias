 ...
 */
class getSetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SetRepository' shared autowired service.
     *
     * @return \App\Repository\SetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SetRepository.php';

        return $container->privates['App\\Repository\\SetRepository'] = new \App\Repository\SetRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
