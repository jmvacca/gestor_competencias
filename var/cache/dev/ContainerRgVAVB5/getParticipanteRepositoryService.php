 ...
 */
class getParticipanteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipanteRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipanteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipanteRepository.php';

        return $container->privates['App\\Repository\\ParticipanteRepository'] = new \App\Repository\ParticipanteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
