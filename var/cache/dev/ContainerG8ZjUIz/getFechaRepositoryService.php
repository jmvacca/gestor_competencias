 ...
 */
class getFechaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FechaRepository' shared autowired service.
     *
     * @return \App\Repository\FechaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FechaRepository.php';

        return $container->privates['App\\Repository\\FechaRepository'] = new \App\Repository\FechaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
