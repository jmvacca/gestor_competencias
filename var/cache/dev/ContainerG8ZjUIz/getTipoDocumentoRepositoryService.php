 ...
 */
class getTipoDocumentoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoDocumentoRepository' shared autowired service.
     *
     * @return \App\Repository\TipoDocumentoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoDocumentoRepository.php';

        return $container->privates['App\\Repository\\TipoDocumentoRepository'] = new \App\Repository\TipoDocumentoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
