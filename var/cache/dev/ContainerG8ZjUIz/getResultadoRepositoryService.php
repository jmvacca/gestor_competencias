 ...
 */
class getResultadoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResultadoRepository' shared autowired service.
     *
     * @return \App\Repository\ResultadoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResultadoRepository.php';

        return $container->privates['App\\Repository\\ResultadoRepository'] = new \App\Repository\ResultadoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
