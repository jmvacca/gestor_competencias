...
return [
    ...
    'competencia_deportiva_fixture_partido_resultado_gestionar_sets' => [['id_competencia', 'id_partido', 'id'], ['_controller' => 'App\\Controller\\CompetenciaDeportivaController::gestionarResultadoSets'], [], [['text', '/sets'], ['variable', '/', '[^/]++', 'id', true], ['text', '/resultado'], ['variable', '/', '[^/]++', 'id_partido', true], ['text', '/fixture'], ['variable', '/', '[^/]++', 'id_competencia', true], ['text', '/competencias']], [], []],
    'competencia_deportiva_fixture_partido_resultado_gestionar_puntuacion' => [['id_competencia', 'id_partido', 'id'], ['_controller' => 'App\\Controller\\CompetenciaDeportivaController::gestionarResultadoPuntuacion'], [], [['text', '/puntuacion'], ['variable', '/', '[^/]++', 'id', true], ['text', '/resultado'], ['variable', '/', '[^/]++', 'id_partido', true], ['text', '/fixture'], ['variable', '/', '[^/]++', 'id_competencia', true], ['text', '/competencias']], [], []],
    'competencia_deportiva_fixture_partido_resultado_gestionar_final' => [['id_competencia', 'id_partido', 'id'], ['_controller' => 'App\\Controller\\CompetenciaDeportivaController::gestionarResultadoFinal'], [], [['text', '/final'], ['variable', '/', '[^/]++', 'id', true], ['text', '/resultado'], ['variable', '/', '[^/]++', 'id_partido', true], ['text', '/fixture'], ['variable', '/', '[^/]++', 'id_competencia', true], ['text', '/competencias']], [], []],
