    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('resultadoLocal', IntegerType::class,
                [
                    'attr'      => ['required'  => true,'min'=>0, 'max'=>9999, 'placeholder'=>'0 - 9999','onkeyup' => "this.value = mMaxVPuntuacionLocal(this,this.value)",'onchange'=>"this.value = igualLocalFunction(this,this.value)", 'name' => 'Resultado Local', 'title' => 'Resultado Local', 'class' => 'form-control', 'id' => 'resultadoLocal',],
                    'required'  => false,
                ])
            ->add('resultadoVisitante', IntegerType::class,
                [
                    'attr'      => ['required'  => true,'min'=>0, 'max'=>9999, 'placeholder'=>'0 - 9999', 'onkeyup' => "this.value = mMaxVPuntuacionVisitante(this,this.value)", 'onchange'=>"this.value = igualVisitanteFunction(this,this.value)",'name' => 'Resultado Visitante', 'title' => 'Resultado Visitante', 'class' => 'form-control', 'id' => 'resultadoVisitante'],
                    'required'  => false,
                ]);
    }
